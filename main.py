...
l4= Label( text='About Tic Tac toe', fg='#192A56',bg='#c4beaf',font=("Helvetica", 13)).grid(row=8, column=0)
...
''', fg='#192A56',bg='#c4beaf',font=("Helvetica", 13)).grid(row=9, column=0)


#empty label to add space between discriptions of tic tac toe and jumbled words
l6= Label( text=' ', fg='#192A56',bg='#c4beaf',font=("Helvetica", 13)).grid(row=10, column=0)

#label for title for discription of Jumbled words
l7= Label( text='About Jumble Words', fg='#192A56',bg='#c4beaf',font=("Helvetica", 13)).grid(row=11, column=0)
...
''',fg='#192A56',bg='#c4beaf',font=("Helvetica", 13)).grid(row=12, column=0 )

#label for discription about tic tac toe
l9= Label( text='Creator - Armaan', fg='#192A56',bg='#c4beaf',font=("Helvetica", 13)).grid(row=13, column=0)
